...
(Polish version below: [link](#ekstrakcja-informacji-z-biogram%C3%B3w-postaci-historycznych-za-pomoc%C4%85-skrypt%C3%B3w-wykorzystuj%C4%85cych-model-gpt-4))
...
In the `short_data_psb_250` directory, there are the results of experiments with shortening biograms based on embeddings and the similarity of biogram sentences to queries. Simpler methods of shortening biographies were also used - by filtering sentences by keywords.
...
Only the family relations of the main character of the biography were searched for.
For 36 out of 250 biographies, the model stated a lack of data on family relations, of which in 34 cases it was correct (94.4%).
In 214 biographies where family relations were found, there were a total of 1451 (found relations and missing relations), of which 1247 were correct (85.9%).

Looking in detail at the types of kinship (for 214 biographies where any were found), 49 types of kinship were considered (some overlap e.g. relative, relatives, etc.). The results could be in the following situations: the family relation was found and is correct, the family relation was found but is incorrect, the relation was not found (but is in the biography). The first of these situations is classified as correct, the other two as incorrect. The results table (20 most popular types of relations, sorted by number in descending order, correctness >90% bolded, <50% italicized) is as follows:
