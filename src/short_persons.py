...
def short_version(text:str) -> str:
    """ proste skracanie biogramów, zdania istotne dla ważnych osób """
    result = ''
    select_data = []
...
if __name__ == '__main__':
    ...
    for nr_tomu in range(1, 52):
        ...
        if not os.path.isdir(Path("..") / 'data_psb' / 'short_persons' / tom ):
            os.mkdir(Path("..") / 'data_psb' / 'short_persons' / tom )
        ...
        for data_file in data_file_list:
            ...
            output_path = Path("..") / 'data_psb' / 'short_persons' / tom / data_file_name
