...
Duża część informacji pobranych z biogramów to "brak danych": 485 z 1500, takich informacji - szczególnie w biogramach postaci ze starszych okresów - po prostu brakuje. Liczba znalezionych informacji dla każdej z kategorii informacji: 
